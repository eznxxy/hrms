@extends('layouts.main', ['title' => 'Resignation'])
...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Resignation</div>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div style="margin-left: auto;">
                            <a href="{{ route('resignations.create') }}" class="btn btn-primary">Resign</a>
                        </div>
                        @endif
                    </div>
                    <div class="card-body">
...
<script>
    jQuery(function() {
        var resignationTable = $('#resignationTable').DataTable({
            ...
            serverSide: true,
            searchDelay: 500,
            ajax: "{{ route('ajax.resignations.index') }}",
            columns: [{
                    "data": "id",
